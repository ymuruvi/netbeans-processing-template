...
public class ProcessingSketchPanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";

    private ProcessingSketchWizardPanel panel;

    public ProcessingSketchPanelVisual(ProcessingSketchWizardPanel panel) {
        initComponents();
        this.panel = panel;
